...
class Detector:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber(
            self.image_topic, CompressedImage, self.image_cb, queue_size=1, buff_size=2**24)
    ...
    def preprocess(self, img):
        ...
        print("height:{} width:{} channels:{}".format(height,width,channels)) # DEBUG
